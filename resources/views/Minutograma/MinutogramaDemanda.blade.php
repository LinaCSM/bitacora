...
@section('Titulo')
    Minutograma por demanda| Getronics
@stop
@section('contenido')

    <legend>Entregables por demanda</legend>

    <div id="tablaDemanda" class="panel-body table-responsive" style="margin-bottom: 30px">
        <table class="table table-striped table-bordered table-hover table-responsive" id="tablaEntregablesDemanda">
            <thead>
            <tr>
                <th>Grupo País</th>
                <th>Job</th>
            ...
            <tbody>
                ...
                @foreach($procesosDemanda as $Proceso)
                <?php $busquedaEntregables = MinutogramaController::buscarEntregables($Proceso->id)?>
                <?php $busquedaEntregas = MinutogramaController::buscarEntregasMensuales($Proceso->id)?>
