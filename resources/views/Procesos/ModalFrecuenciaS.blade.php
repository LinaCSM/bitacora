<div class="modal fade" id="modalFSemanal" role="dialog" style="overflow-y: auto; z-index:1100" >
    <div class="modal-content" role="dialog" id="modalTipo1" >
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" onclick="CancelarNuevo()">&times;</button>
            ...
            <div class="modal-body semanal">
                <div class="col-md-12">
                    ...
                    <div class="col-md-4" style="margin-top: 20px;">
                        ...
                        <button class="btn"  data-dismiss="modal" onclick="CancelarNuevo()" id="btnCancelar">Cancelar</button>
                    </div>
