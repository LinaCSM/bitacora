...
@section('Titulo')
    Procesos diarios | Getronics
@stop
@section('contenido')

    <legend>Procesos diarios</legend>
    ...
    <div class="panel-body table-responsive" style="margin-bottom: 30px;">
        <table class="table table-striped table-bordered table-hover table-responsive" id="tablaProcesos">
            ...
            @foreach($procesosDiarios as $Proceso)
                ...
                <tr>
                    ...
                    <td>
                        ...
                        @if($tipoUsuario=="1" || $tipoUsuario=="2")
                            <button href="#" class="btn  btn-xs" data-toggle="modal" data-backdrop="static" title="Editar" data-target="#editarProceso{{$Proceso -> id}}"
    ...
    <div class="form-group" style="width: 200px">
        <form action="{{route('downloadProcesosDiarios')}}">
